...
@interface SVCurrentResultViewCtrl () <UITableViewDelegate,
...
- (void)viewDidLoad {
  ...
  UIView *uiview =
      [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenW, kScreenH)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  UIImageView *_imgView = [[UIImageView alloc]
      initWithFrame:CGRectMake(kMargin * 2, (kCellH - imgViewWAndH) * 0.5,
                               imgViewWAndH, imgViewWAndH)];
  _imgView.image = [UIImage imageNamed:@"ic_video_label"];
  [_bgdBtn addSubview:_imgView];

  UIImageView *_rightImgView = [[UIImageView alloc]
      initWithFrame:CGRectMake(kViewW(_bgdBtn) - imgViewWAndH - kMargin,
  ...
  UILabel *firstBufferTimeLabel = [[UILabel alloc]
      initWithFrame:CGRectMake(kViewR(uvMosLabel) + 15, kViewY(_imgView) + 10,
                               80, imgViewWAndH)];
  ...
  UILabel *cuttonTimesLabel = [[UILabel alloc]
      initWithFrame:CGRectMake(kViewR(firstBufferTimeLabel) + 15,
                               kViewY(_imgView) + 10, 60, imgViewWAndH)];
...
- (UITableView *)buildTableView {
  UITableView *tableView =
      [[UITableView alloc] initWithFrame:CGRectMake(0, 0, kScreenW, 500)
...
- (UIButton *)buildTestBtn {
  ...
  //按钮尺寸
  _reTestButton.frame =
      CGRectMake(kMargin * 4, kScreenH - 200, kScreenW - kMargin * 8, testBtnH);
  //按钮圆角
  _reTestButton.layer.cornerRadius = kCornerRadius;
  //设置按钮的背景色
  _reTestButton.backgroundColor = [UIColor colorWithRed:51 / 255.0
                                                  green:166 / 255.0
                                                   blue:226 / 255.0
                                                  alpha:1.0];
  //按钮文字颜色和类型
  [_reTestButton setTitleColor:[UIColor whiteColor]
...
- (void)initBarButton {
  ...
  UIImageView *imageView =
      [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 100, 30)];
  //设置图片名称
