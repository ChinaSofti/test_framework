...
- (UILabel *)testDate
{
    if (_testDate == nil)
    {
        ...
        _testDate.font = [UIFont systemFontOfSize:kScreenW / 23];
...
- (UILabel *)testTime
{
    if (_testTime == nil)
    {
        ...
        _testTime.font = [UIFont systemFontOfSize:kScreenW / 30];
...
- (UILabel *)videoMOS
{
    if (_videoMOS == nil)
    {
        ...
        _videoMOS.frame =
        CGRectMake (kScreenW * 2 / 5 - 5, (CellHeight - LabelHeight) / 2, kScreenW / 5, LabelHeight);
        _videoMOS.textColor = [UIColor grayColor];
        _videoMOS.font = [UIFont systemFontOfSize:kScreenW / 23];
...
- (UILabel *)loadTime
{
    if (_loadTime == nil)
    {
        ...
        _loadTime.frame =
        CGRectMake (kScreenW * 3 / 5 - 5, (CellHeight - LabelHeight) / 2, kScreenW / 5, LabelHeight);
        _loadTime.textColor = [UIColor grayColor];
        _loadTime.font = [UIFont systemFontOfSize:kScreenW / 23];
...
- (UILabel *)bandWidth
{
    if (_bandWidth == nil)
    {
        ...
        _bandWidth.frame =
        CGRectMake (kScreenW * 4 / 5 - 5, (CellHeight - LabelHeight) / 2, kScreenW / 6, LabelHeight);
        _bandWidth.textColor = [UIColor grayColor];
        _bandWidth.font = [UIFont systemFontOfSize:kScreenW / 23];
...
- (void)setResultModel:(SVSummaryResultModel *)resultModel
{
    ...
    if ([resultModel.type isEqualToString:@"Mobile"])
    {
        self.imgViewType.image = [UIImage
                                   imageNamed:@"ic_network_type_mobile"];
    }
    else if ([resultModel.type isEqualToString:@"WIFI"])
    {
        self.imgViewType.image = [UIImage
                                   imageNamed:@"ic_network_type_wifi"];
    }

    self.testDate.text = resultModel.date;
    self.testTime.text = resultModel.time;
    
    self.videoMOS.text = resultModel.UvMOS;
    self.loadTime.text = resultModel.loadTime;
    self.bandWidth.text = resultModel.bandwidth;
 
   
    
}
//- (void)setWebModel:(SVWebTestModel *)webModel
//{
//    //   NSArray * array = @[@"01/26", @"19:33:20", @"--", @"1.90s", @"--"];
//    if ([webModel.networkType isEqualToString:@"Mobile"])
//    {
//        self.imgViewType.image = [[UIImage
//        imageNamed:@"ic_network_type_mobile"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
//    }
//    else if ([webModel.networkType isEqualToString:@"WIFI"])
//    {
//        self.imgViewType.image = [[UIImage
//        imageNamed:@"ic_network_type_wifi"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
//    }
//
//    self.testDate.text = webModel.date;
//
//    self.testTime.text = webModel.time;
//
//    self.videoMOS.text = @"--";
//
//    self.loadTime.text = webModel.loadDuration;
//
//    self.bandWidth.text = @"--";
//
//}
//- (void)setBandwidthModel:(SVBandWidthModel *)bandwidthModel
//{
//    //   NSArray * array = @[@"01/26", @"19:33:20", @"--", @"1.90s", @"--"];
//    if ([bandwidthModel.networkType isEqualToString:@"Mobile"])
//    {
//        self.imgViewType.image = [[UIImage
//        imageNamed:@"ic_network_type_mobile"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
//    }
//    else if ([bandwidthModel.networkType isEqualToString:@"WIFI"])
//    {
//        self.imgViewType.image = [[UIImage
//        imageNamed:@"ic_network_type_wifi"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
//    }
//
//    self.testDate.text = bandwidthModel.date;
//
//    self.testTime.text = bandwidthModel.time;
//
//    self.videoMOS.text = @"--";
//
//    self.loadTime.text = @"--";
//
//    self.bandWidth.text = bandwidthModel.downloadSpeed;
//
//}
