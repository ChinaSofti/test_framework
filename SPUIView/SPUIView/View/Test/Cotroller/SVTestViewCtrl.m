...
@interface SVTestViewCtrl () <SVToolCellDelegate, UITableViewDelegate,
...
- (void)viewDidLoad
{
    ...
    NSString *title = [CTi18n:@"VideoTest"];
    NSLog(@"%@", title);
    NSArray* sourceA
        = @[
             @{
        ...
        cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    SVToolCell* cell =
        [[SVToolCell alloc] initWithStyle:UITableViewCellStyleDefault
    ...
    viewForHeaderInSection:(NSInteger)section
{
    ...
    if (section == 0) {
        ...
        UILabel* label = [[UILabel alloc]
            initWithFrame:CGRectMake(kMargin, 0, kScreenW - kMargin, kFirstHederH)];
        label.text = @"选择测试项";
...
- (UIButton*)testBtn
{
    if (_testBtn == nil) {
        ...
        //按钮尺寸
        _testBtn.frame = CGRectMake(kMargin * 4, kLastFooterH - testBtnH,
            kScreenW - kMargin * 8, testBtnH);
        //按钮背景颜色
        _testBtn.backgroundColor = [UIColor colorWithRed:229 / 255.0
                                                   green:229 / 255.0
                                                    blue:229 / 255.0
                                                   alpha:1.0];
        //按钮文字和类型
        ...
        //按钮文字颜色和类型
        [_testBtn setTitleColor:[UIColor lightGrayColor]
...
{
    //设置按钮的背景色
    self.testBtn.backgroundColor = [UIColor colorWithRed:51 / 255.0
                                                   green:166 / 255.0
                                                    blue:226 / 255.0
                                                   alpha:1.0];
    //设置按钮可以点击
    ...
    if (!_selectedMA.count) {
        self.testBtn.backgroundColor = [UIColor colorWithRed:229 / 255.0
                                                       green:229 / 255.0
                                                        blue:229 / 255.0
                                                       alpha:1.0];
        //设置按钮不可点击
